...
### P2
- AI prompt testing for agent scripts inside the app
- Twilio/VAPI for outbound AI calls + recording playback + live transcripts
- Stripe/Razorpay 3-plan subscription billing in Settings
- CRM integrations, white-label, mobile app

## Changelog
- **Initial app build**: header dropdowns, calendar new Date(), full CRUD on Agents/Leads/Campaigns/Call History/Import, deletes auto-update UI, sonner toast bottom-right.
